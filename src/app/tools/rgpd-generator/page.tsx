...
export default function RgpdGenerator() {
  ...
  return (
    <div>
      ...
      <p className="mt-2 text-gray-600">
        Remplis ce formulaire pour générer un point de départ. Ce n'est pas un
        avis juridique.
      </p>
      ...
      {generated && (
        <div className="mt-8">
          <pre className="whitespace-pre-wrap rounded-md border border-gray-200 bg-gray-50 p-4 text-sm">
            {generated}
          </pre>
          <button
            onClick={download}
